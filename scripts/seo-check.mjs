...
const PAGES = [
  ...
  "/services/web-design/daytona-beach",
  "/services/seo-marketing/daytona-beach",
  "/services/ai-solutions/daytona-beach",
  "/services/web-design/vero-beach",
  "/services/seo-marketing/vero-beach",
  "/services/ai-solutions/vero-beach",
  "/blog",
